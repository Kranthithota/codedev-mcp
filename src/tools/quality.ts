    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                ...
                return { content: [{ type: 'text', text: `find_todos failed: ${error.message}` }], isError: true };
            }
        },
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                ...
                return { content: [{ type: 'text', text: `find_debug_logs failed: ${error.message}` }], isError: true };
            }
        },
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                ...
                return { content: [{ type: 'text', text: `find_secrets failed: ${error.message}` }], isError: true };
            }
        },
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                ...
                return { content: [{ type: 'text', text: `find_empty_catches failed: ${error.message}` }], isError: true };
            }
        },
    );
        ...
        async (params) => {
            if (params.pattern) {
                try {
                    ...
                    return { content: [{ type: 'text', text: `find_duplicates failed: ${error.message}` }], isError: true };
                }
            }
            return {
                content: [
