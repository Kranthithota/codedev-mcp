            ...
            try {
                ...
                return {
                    ...
                    structuredContent: {
                        action: 'extract',
                        file: params.file,
                        entries: filtered.map((d: any) => ({ symbol: d.name, type: d.kind, line: d.line })),
                ...
                return {
                    content: [
                        {
                            type: 'text',
                            text: `code_docs failed: ${error.message}. Verify the file exists and is a supported language.`,
                        },
                    ],
                    isError: true,
                };
