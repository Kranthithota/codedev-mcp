            ...
            try {
                ...
                switch (params.action) {
                    case 'analyze': {
                        ...
                        return { content: [{ type: 'text', text: output }], structuredContent: { action: 'outline', data: output } };
                    }
                ...
                return {
                    content: [
                        {
                            type: 'text',
                            text: `notebook_analyze failed: ${error.message}. Verify the file is a valid .ipynb notebook.`,
                        },
                    ],
                    isError: true,
                };
